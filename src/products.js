export const featuredSneakers = [
  {
    id: 1, brand: "Nike", name: "ACG Phassad 'Black/Yellow'", price: 110, gender: "Unisex", color: "Black/Yellow", stockLevel: 5,
  ...
  {
    id: 2, brand: "New Balance", name: "2002R Protection Pack x BAPE", price: 450, gender: "Unisex", color: "Grey Camo", stockLevel: 0,
  ...
  {
    id: 3, brand: "Adidas", name: "Samba Classic", price: 110, gender: "Unisex", color: "White", stockLevel: 10,
  ...
  {
    id: 4, brand: "Jordan", name: "Air Jordan 1 'Chicago' (2015)", price: 1250, gender: "Unisex", color: "Red/Black", stockLevel: 2,
  ...
  {
    id: 5, brand: "New Balance", name: "990v6 'Grey'", price: 200, gender: "Unisex", color: "Grey", stockLevel: 5,
  ...
  {
    id: 6, brand: "puma", name: "Playmaker'Spray-Lakers", price: 190, gender: "Unisex", color: "Grey/Green", stockLevel: 8,
  ...
  {
    id: 7, brand: "Nike", name: "SB Dunk Low 'Travis Scott'", price: 1800, gender: "Unisex", color: "Brown/Black/White", stockLevel: 3,
  ...
  {
    id: 8, brand: "Nike", name: "Corteiz x Nike Air Max 95 SP 'Rules the World - Sequoia'", price: 380, gender: "Unisex", color: "Green/Olive", stockLevel: 5,
  ...
  {
    id: 9, brand: "Nike", name: "Nike Vomero 5 trainers in white", price: 150, gender: "Unisex", color: "White", stockLevel: 10,
  ...
  {
    id: 10, brand: "New Balance", name: "Ellipse v1 sneakers'White/blue'", price: 120, gender: "Unisex", color: "White/purple", stockLevel: 7,
  ...
  {
    id: 11, brand: "Nike", name: "Jordan 1 Retro Low OG SP 'Travis Scott Mocha'", price: 120, gender: "Unisex", color: "Black/Brown", stockLevel: 5,
  ...
  {
    id: 12, brand: "Asics", name: "Gel-Kayano 14 'Cream/Sweet Pink'", price: 150, gender: "Unisex", color: "white/Sweet Pink", stockLevel: 8,
  ...
  {
    id: 13, brand: "Maison Mihara Yasuhiro", name: "Hank OG Sole Low Canvas Sneakers", price: 140, gender: "Unisex", color: "black/White", stockLevel: 6,
  ...
  {
    id: 14, brand: "Miu Miu", name: "Miu Miu X New Balance 530 'Cinnamon'", price: 150, gender: "Unisex", color: "brown", stockLevel: 4,
  ...
  {
    id: 15, brand: "adidas", name: "Deer-est Tokyo Mary Jane 'Brown Desert'", price: 160, gender: "Women", color: "Brown/pink", stockLevel: 6,
  ...
  {
    id: 16, brand: "Onitsuka Tiger", name: "Mexico 66 'Yellow/Black'", price: 130, gender: "Unisex", color: "Yellow/Black", stockLevel: 9,
  ...
  {
    id: 18, brand: "adidas", name: "Samba Lt 'White'", price: 110, gender: "Unisex", color: "White", stockLevel: 8,
  ...
  {
    id: 19, brand: "puma", name: "Speedcat Suede Ballet 'White'", price: 180, gender: "Women", color: "White/pink", stockLevel: 7,
