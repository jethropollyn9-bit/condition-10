    ...
    <div className="pt-40 pb-24 px-6 max-w-[1200px] mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-zinc-500 text-lg leading-relaxed">Founded in 2026, Condition 10 was born out of frustration. The sneaker aftermarket had become too noisy, too risky, and too crowded. We wanted a place where collectors didn't have to second-guess what they were buying.</p>
        ...
        <div className="bg-zinc-100 rounded-2xl overflow-hidden shadow-2xl aspect-square"><img src="https://images.unsplash.com/photo-1552346154-21d32810baa3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Sneaker Collection" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 hover:scale-105" /></div>
      </div>
    </div>
  );
}
